...
(define scheme-y (make-scheme-number 4))
(eqn? scheme-x scheme-y)

(define complex-x (make-complex-from-real-imag 1 3))
(define complex-y (make-complex-from-real-imag 1 3))
(eqn? complex-x complex-y)

;;写了这个，基本上明白了数据导向。之前的题解中很多内容没有写全，也不要参考了。下次会完善。